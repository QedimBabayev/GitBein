        ...
        const returnElementId = (
            match.params.id ?
                this.props.state.datas.fetchingEdit ? <div>Loading...</div> :
                    <div>
                        <CreatePaymentInForm datas={this.props.state.spenditems.spendItems} owners={this.props.state.owdep.owners} departments={this.props.state.owdep.departments} selectedDoc={this.props.state.datas.pagePositions} />
                    </div>
                :
                <div>
                    <CreatePaymentInForm datas={this.props.state.spenditems.spendItems} owners={this.props.state.owdep.owners} departments={this.props.state.owdep.departments} fromDoc = {this.props.location.state ? this.props.location.state.fromdoc : ''} saledoc={ this.props.location.state ? this.props.location.state.doc : ''} />
                </div>
