...
import cols from '../ColNames/Documents/colNames'
        ...
        return (
            <Row className={'table_holder_section'}>
                ...
                <Col xs={24} md={24} xl={24}>
                    <ResponsiveTable cols={cols} columns={cols.filter(c => c.hidden == false)} redirectTo={'editDocument'} from={'documents'} editPage={'editDocument'} foredit={'documents'} />
                </Col>
