    ...
    return dispatch => {
        dispatch({
            ...
            payload: axios.post(`${API_MODS}/putrefitem.php`,
                ...
                .then(data => data.Body.ResponseStatus === '0' ? dispatch(getRefLists({ token: getToken(), refid: id })) : alert('sehv'))
        })
    ...
    return dispatch => {
        dispatch({
            ...
            payload: axios.post(`${API_MODS}/putcustomref.php`,
                ...
                .then(data => data.Body.ResponseStatus === '0' ? dispatch(getRefTypes({ token: getToken() })) : alert('sehv'))
        })
    ...
    return dispatch => {
        dispatch({
            ...
            payload: axios.post(`${API_MODS}/delrefitem.php?id=` + id,
                ...
                .then(data => data.Body.ResponseStatus === '0' ? dispatch(getRefLists({ token: getToken(), refid: ref })) : alert('sehv'))
        })
