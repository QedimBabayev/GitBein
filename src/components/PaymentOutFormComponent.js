                    ...
                    initialValues={
                        {
                            ...
                            spenditem: Object.keys(this.props.doc).length > 0 ? this.props.doc.SpendItem : Object.keys(this.props.saledoc).length > 0 ? this.props.state.spenditems.spendItems.find(s => s.StaticName === 'buyproduct').Id : this.props.state.spenditems.spendItems.find(s => s.StaticName === 'buyproduct').Id,
...
export default connect(mapStateToProps, mapDispatchToProps)(LoaderDocHOC(PaymentOutFormComponent, 'fetching'))
