            ...
            <div className='table_holder'>
                <Row>
                    ...
                    <Col xs={24} md={12} xl={13}>
                        <PaymentInFormComponent datas={this.props.datas} fetching={this.props.state.groups.fetching} fromdoc= {this.props.fromDoc} saledoc={this.props.saledoc} docid={this.state.docid} doc={this.state.doc} />
                    </Col>
                </Row >
...
export default connect(mapStateToProps, mapDispatchToProps)(LoaderHOC(CreatePaymentInForm, 'datas'))