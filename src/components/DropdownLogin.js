...
const DropdownLogin = (props) => {
    ...
    return (
        <Dropdown onOpen={onOpen} onClose={onClose} className='flex-direction-column-center admin_menu' text={<div className='admin_dropdown_text'>  <img style={{margin:'0'}} className='small_logo_pics' src={`/images/settingsadmin.png`} /> <span>Ayarlar</span></div>}>
            <Dropdown.Menu>
