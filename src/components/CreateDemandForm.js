...
class CreateDemandForm extends Component {
    ...
    render() {
        ...
        const menu = (
            <Menu>
                <Menu.Item key="0">
                    <Button className='flex_directon_col_center' disabled={this.props.id ? false : true}>
                        Arxivə yerləşdir
                    </Button>
                </Menu.Item>
                <Menu.Item key="1">
            ...
            <div className='table_holder'>
                <Row>
                    ...
                    <Col xs={24} md={24} xl={24} className='form_header_wrapper'>
                        ...
                        <DocButtons errorFields={errorFields} from={this.props.fromdoc ? this.props.fromdoc : 'p=demand'} linkedDocs={this.props.id ? false : true} doc={this.props.state.datas.doc} toDoc='createPaymentIn' toLinked = '/createDemandReturn' fromDoc='createDemand' buttonsName={buttonsNames} activeitem={this.props.state.navbar.activeItem} activesubitem={this.props.state.navbar.activeSubItem} />
                    ...
                    <Col xs={24} md={12} xl={13}>
                        <DemandFormComponent docid={this.props.id ? this.props.state.datas.doc[0].Id : ''} datas={this.props.state.groups.groups} doc={this.props.id ? this.props.state.datas.doc[0] : ''} />
                    </Col>
                    <Col xs={24} md={24} xl={24}>
...
export default connect(mapStateToProps, mapDispatchToProps)(LoaderDocHOC(CreateDemandForm, 'fetching'))