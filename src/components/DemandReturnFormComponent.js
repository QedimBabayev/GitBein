...
class DemandReturnFormComponent extends Component {
    ...
    render() {
        ...
        const customerOption = (
            this.props.saledoc ? <Option key={this.props.saledoc.doc.CustomerId}>{this.props.saledoc.doc.CustomerName}</Option> :
        ...
        console.log(this.props.saledoc)
        return (
                    ...
                    initialValues={
                        {
                            ...
                            customerid: this.props.doc ? this.props.doc.CustomerId : this.props.saledoc ? this.props.saledoc.doc.CustomerId : '',
                            ...
                            id: this.props.doc ? this.props.doc.Id : this.state.editid ? this.state.editid : this.props.saledoc ? this.props.saledoc.doc.Id : '',
                            mark: this.props.doc ? this.props.doc.Mark : this.props.saledoc ? this.props.saledoc.doc.Mark : '',
                        }
                    }
                    layout="horizontal"
