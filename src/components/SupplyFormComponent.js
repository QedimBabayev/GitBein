...
import {
    Form, Input, Button, message, InputNumber, TreeSelect, Checkbox, Dropdown, DatePicker, Switch, Select, Spin, Tag, Divider, Menu, Col, Row, Collapse
} from 'antd';
...
class SupplyFormComponent extends Component {
    ...
    async putDoc(object) {
        const res = await axios.post(`${API_BASE}/supplies/put.php`, object);
        return await res;
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(LoaderHOC(SupplyFormComponent, 'datas'))
