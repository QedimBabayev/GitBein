            ...
            <div >
                ...
                <List
                    ...
                    renderItem={item => (
                        <List.Item
                            key={item.Id}
                            actions={[<a key="list-loadmore-edit" id={item.Id} onClick={this.onClick}>dəyiş</a>, <Popconfirm onConfirm={(e) => this.deleteListItem(item.Id, e)} title="Silməyə əminsiniz?" okText="Bəli" cancelText="Xeyr">
                                <a key="list-loadmore-more">sil</a>
                            </Popconfirm>]}
                        >
                            <List.Item.Meta
