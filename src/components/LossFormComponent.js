...
import {
    Form, Input, Button, InputNumber, message, TreeSelect, Checkbox, Dropdown, DatePicker, Switch, Select, Spin, Tag, Divider, Menu, Col, Row, Collapse
} from 'antd';
...
class LossFormComponent extends Component {
    ...
    async putDoc(object) {
        const res = await axios.post(`${API_BASE}/losses/put.php`, object);
        return await res;
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(LoaderHOC(LossFormComponent, 'datas'))
