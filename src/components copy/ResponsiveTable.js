...
const RemotePagination = ({ data, loading, page, defaultSorted, sizePerPage, onTableChange, totalSize }) => (
    <BootstrapTable
        remote
        keyField='BarCode'
        data={data}
...
class ResponsiveTable extends Component {
    ...
    handleTableChange = (type, { page, sizePerPage }) => {
        ...
        if (getToken() && page != this.state.page) {
        ...
        return (
            ...
            <div className='table-container'>
                ...
                <RemotePagination
                    ...
                    sizePerPage={this.props.state.datas.totalLimit}
                    totalSize={this.props.state.datas.totalDatas}
                    defaultSorted={defaultSorted}
...
const mapDispatchToProps = {
    fetchData, updateSelectedRows, fetchDocuments
}
