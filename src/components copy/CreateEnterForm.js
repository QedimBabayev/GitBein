...
class CreateEnterForm extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            docid: this.props.selectedDoc[0] ? this.props.selectedDoc[0].Id : '',
            positions: this.props.selectedDoc[0] ? this.props.selectedDoc[0].Positions : [],
            status: false,
            errorFields: [],
            ...
            <div className='table_holder'>
                <Row>
                    ...
                    <Col xs={24} md={24} xl={24} className='form_header_wrapper'>
                        ...
                        <DocButtons errorFields={errorFields} from={this.props.fromdoc ? this.props.fromdoc : 'p=enter'}  linkedDocs = {this.state.doc.length === 0 ? true : false} doc={this.state.doc} toDoc='createPaymentOut' fromDoc = 'createEnter' buttonsName={buttonsNames} activeitem={this.props.state.navbar.activeItem} activesubitem={this.props.state.navbar.activeSubItem} />
                    ...
                    <Col xs={24} md={12} xl={13}>
                        <EnterFormComponent datas={this.props.datas} fetching={this.props.state.groups.fetching} docid={this.state.docid} doc={this.state.doc} />
                    </Col>
                    <Col xs={24} md={24} xl={24}>
                        <DocTable visible={this.state.visible} linkedid={this.state.doc ? this.state.doc.Id : ''} from='enters' doc={this.state.doc} handleProduct={this.props.state.handleProduct.selectedProduct} datasource={this.state.positions} />
                    </Col>
                </Row >
