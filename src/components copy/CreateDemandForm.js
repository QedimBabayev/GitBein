    ...
    render() {
        ...
        const check = (
            <Menu>
                ...
                <Menu.Item key="2">
                    <Link to={{ pathname: '/check80', search: `${this.props.id}` }} target={'_blank'} >80mm </Link>
            ...
            <div className='table_holder'>
                <Row>
                    ...
                    <Col xs={24} md={24} xl={24} className='form_header_wrapper'>
                        ...
                        <DocButtons errorFields={errorFields} from={this.props.fromdoc ? this.props.fromdoc : 'p=demand'} linkedDocs={this.state.doc.length === 0 ? true : false} doc={this.state.doc} toDoc='createPaymentIn' fromDoc='createDemand' buttonsName={buttonsNames} activeitem={this.props.state.navbar.activeItem} activesubitem={this.props.state.navbar.activeSubItem} />
