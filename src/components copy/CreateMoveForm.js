            ...
            <div className='table_holder'>
                <Row>
                    ...
                    <Col xs={24} md={12} xl={13}>
                        <MoveFormComponent datas={this.props.datas} fetching={this.props.state.groups.fetching} docid={this.state.docid} doc={this.state.doc} />
                    </Col>
                    <Col xs={24} md={24} xl={24}>
                        <DocTable visible={this.state.visible} linkedid={this.state.doc ? this.state.doc.Id : ''} from='moves' doc={this.state.doc} handleProduct={this.props.state.handleProduct.selectedProduct} datasource={this.state.positions} />
                    </Col>
                </Row >
